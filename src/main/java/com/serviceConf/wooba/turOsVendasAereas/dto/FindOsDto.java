...
public class FindOsDto {
    ...
    public FindOsDto(String numero, Date dataAbertura, Date dataViagem, Integer passageiro, String descricao, String solicitanteNome, String solicitanteEmail, String campoExtra1Descricao, String campoExtra2Valor, String campoExtra3Descricao, String campoExtra4Descricao, Integer id) {
        this.numero = numero;
